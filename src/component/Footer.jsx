...
function Footer() {
  return (
    <div className='flex gap-5 w-full h-screen p-20 bg-zinc-900 font-["Founders_Grotesk_X-Condensed"]'>
      <div className='w-1/2 h-full flex flex-col justify-between font-["Founders_Grotesk_X-Condensed"] mt-6'>
        <div className='heading'>
            <h1 className=' font-semibold text-[8vw] uppercase leading-none -mb-10 '>EYE-</h1>
            <h1 className=' font-semibold text-[8vw] uppercase leading-none -mb-10'>OPENING</h1>
        </div>
      ...
      <div className='w-1/2 mt-6 '>
        <h1 className=' font-semibold text-[8vw] uppercase leading-none -mb-10 '>PRESENTATIONS</h1>
        ...
        <div className='dets font-["Neue_Montreal"] mt-10'>
            ...
            <a className='block text-2xl underline font-light' href='#'>202-1965 W 4th Ave</a>
            <a className='block text-2xl underline font-light' href='#'>Vancouver, Canada</a>
            <a className='block text-2xl underline font-light' href='#'>30 Chukarina St</a>
        </div>
      </div>
    </div>
  )
